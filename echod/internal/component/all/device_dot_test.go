...
var notOnThisDevice = []string{
	...
	"screen_now_playing", "screen_weather_animation", "screen_at_night", "screen_night_end", "screen_night_hours", "screen_night_light_level", "screen_night_start", "screen_dashboard", "screen_dashboard_idle", "screen_dashboard_kiosk", "screen_dashboard_view",
	"screen_web_access",
