...
// chase lights every third segment and steps the pattern round, the theater marquee. Every third,
...
//
// Each lamp keeps its own color from the palette, so a wheel is a marquee of four different lamps
